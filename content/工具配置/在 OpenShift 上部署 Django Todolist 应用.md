...
首先去 Openshift 上创建一个 Django 应用, 关于怎么创建 Openshift 应用参考我[另一篇笔记](http://www.smallcpp.com/wan-jie-ba-tan-xi-qiang-you-ya-de-fan-qiang.html)

我这里创建了一个 `todolist-smallcpp.rhcloud.com`, 然后, 利用[另一篇笔记](http://www.smallcpp.com/wan-jie-ba-tan-xi-qiang-you-ya-de-fan-qiang.html)的知识用 SecureCRT 连上我们的服务器.

**补充一下用 putty.exe 连接的方法.**

首先, 和[另一篇笔记](http://www.smallcpp.com/wan-jie-ba-tan-xi-qiang-you-ya-de-fan-qiang.html)中一样, 通过 [Git 简明手册](http://www.smallcpp.com/git-jian-ming-shou-ce.html#101-ssh-key) 拿到了两个密钥文件: id\_rsa(私钥) 和 id\_rsa.pub(公钥), 将 id\_rsa.pub(公钥) 部署到刚创建的 Django 应用上.
